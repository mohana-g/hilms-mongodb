...
//     try {
//       const response = await fetch('https://hilms-mongodb.onrender.com/api/courses/popular');
//       if (!response.ok) {
...
//           <img src="https://hilms-mongodb.onrender.com/uploads/istockphoto-1392125218-612x612.jpg" alt="Teaching Platform" />
//           </div>
//         </div>
//       </section>
  ...
  const fetchPopularCourses = async () => {
    try {
      const response = await fetch(
        'https://hilms-mongodb.onrender.com/api/courses/popular'
      );
...
const fetchCareerPaths = async () => {
  try {
    const response = await fetch('https://hilms-mongodb.onrender.com/api/career-paths');
    ...
    <div className="home-container">
      ...
      <section className="teach-section">
        <div className="teach-content">
          ...
          <div className="teach-image">
            <img
              src="https://hilms-mongodb.onrender.com/uploads/istockphoto-1392125218-612x612.jpg"
