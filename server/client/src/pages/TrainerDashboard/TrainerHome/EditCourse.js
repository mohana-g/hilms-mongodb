...
const EditCourse = () => {
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        const response = await axios.get(`https://hilms-mongodb.onrender.com/api/courses/${courseId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://hilms-mongodb.onrender.com/api/courses/${courseId}`, formData, {
