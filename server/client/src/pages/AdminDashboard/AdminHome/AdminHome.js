...
const AdminDashboard = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await axios.get('https://hilms-mongodb.onrender.com/api/admin/users');
  ...
  const fetchTrainers = async () => {
    ...
    try {
      const response = await axios.get('https://hilms-mongodb.onrender.com/api/admin/pending-trainers');
  ...
  const fetchCourses = async () => {
    ...
    try {
      const response = await axios.get('https://hilms-mongodb.onrender.com/api/admin/courses');
  ...
  const fetchLearnersProgress = async () => {
    ...
    try {
      const response = await axios.get('https://hilms-mongodb.onrender.com/api/admin/learners-progress');
  ...
  const fetchLeaderboard = async () => {
    ...
    try {
      const response = await axios.get("https://hilms-mongodb.onrender.com/api/learner/leaderboard");
  ...
  const blockUser = async (userId) => {
    confirmAction("Are you sure you want to block this user?", async () => {
        try {
            const response = await axios.put(`https://hilms-mongodb.onrender.com/api/admin/block-user/${userId}`);
  ...
  const unblockUser = async (userId) => {
      confirmAction("Are you sure you want to unblock this user?", async () => {
          try {
              const response = await axios.put(`https://hilms-mongodb.onrender.com/api/admin/unblock-user/${userId}`);
  ...
  const deleteUser = async (userId) => {
      confirmAction("Are you sure you want to delete this user?", async () => {
          try {
            await axios.delete(`https://hilms-mongodb.onrender.com/api/admin/delete-user/${userId}`);
  ...
  const deleteCourse = async (courseId) => {
    confirmAction('Are you sure you want to delete this course?', async () => {
      try {
        await axios.delete(`https://hilms-mongodb.onrender.com/api/admin/delete-course/${courseId}`);
        fetchCourses();
      } catch (error) {
  ...
  const approveTrainer = async (trainerId) => {
    confirmAction('Are you sure you want to approve this trainer?', async () => {
      try {
        await axios.put(`https://hilms-mongodb.onrender.com/api/admin/approve-trainer/${trainerId}`);
        fetchTrainers();
      } catch (error) {
  ...
  const declineTrainer = async (trainerId) => {
    confirmAction('Are you sure you want to decline this trainer?', async () => {
      try {
        await axios.put(`https://hilms-mongodb.onrender.com/api/admin/decline-trainer/${trainerId}`);
        fetchTrainers();
      } catch (error) {
           ...
           <div className="course-cards">
            ...
            course.description.toLowerCase().includes(searchCourseQuery.toLowerCase())
                ...
                .map((course) => (
                  ...
                  <img src={`https://hilms-mongodb.onrender.com${course.imageurl}`} alt={course.title} className="course-image" />
