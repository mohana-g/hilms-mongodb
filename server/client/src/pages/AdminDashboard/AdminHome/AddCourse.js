...
const AddCourse = () => {
  ...
  useEffect(() => {
    const fetchTrainers = async () => {
      try {
        const response = await axios.get("https://hilms-mongodb.onrender.com/api/admin/trainers");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://hilms-mongodb.onrender.com/api/admin/add-course", formData, {
