...
function LearnerHome() {
  ...
  useEffect(() => {
    const fetchCareerPaths = async () => {
      try {
        const response = await axios.get("https://hilms-mongodb.onrender.com/api/career-paths");
  ...
  useEffect(() => {
    const fetchEnrolledCourses = async () => {
      try {
        ...
        const response = await axios.get("https://hilms-mongodb.onrender.com/api/learner/enrolled-courses", {
